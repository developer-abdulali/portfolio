  ...
  return (
    <>
      <section className="flex flex-col justify-between items-center mt-10 sm:flex-row sm:mx-10 mxl:mx-10 lg:justify-around lg:px-10">
        <div>
          <h1 className="font-semibold text-2xl mt-10 text-center sm:text-3xl sm:text-left mxl:text-4xl">
            Hi, I am ABDUL ALI
          </h1>
          <br />
          ...
          <Link target="_blank" href="https://drive.google.com/file/d/117sXK-wZNGog_Odlx0gsxuyjVjsrYgOH/view?usp=drive_link">
